...
async function main() {
    ...
    assert.equal(overview.protocol.foodWriteEvidence, 'unproven');
    ...
    console.log('✅ dog food write path remains explicitly unsupported PASS');
    console.log('✅ unknown top-level field 7 claimable count is preserved PASS');
    console.log('✅ no write/claim/feed method touched PASS');
    console.log('\n=== RESULT ===');
