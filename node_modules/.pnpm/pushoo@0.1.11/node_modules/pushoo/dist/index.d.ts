...
export type ChannelType = 'webhook' | 'qmsg' | 'serverchan' | 'serverchain' | 'pushplus' | 'pushplushxtrip' | 'dingtalk' | 'wecom' | 'bark' | 'gocqhttp' | 'onebot' | 'atri' | 'pushdeer' | 'igot' | 'telegram' | 'feishu' | 'ifttt' | 'wecombot' | 'discord' | 'wxpusher' | 'join';
/**
...
declare function notice(channel: ChannelType | string, options: CommonOptions): Promise<any>;
